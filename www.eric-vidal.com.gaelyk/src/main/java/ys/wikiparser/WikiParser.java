...
/**
 * ys.wikiparser.WikiParser.renderXHTML() is the main method of this class.
 * It takes wiki-text and returns XHTML.
 *
 * ys.wikiparser.WikiParser's behavior can be customized by overriding appendXxx() methods,
...
public class WikiParser {
  ...
  protected void appendHtml(String text) {
      sb.append(text);
  }
